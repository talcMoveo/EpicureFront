...
const Header: React.FC = () => {
  ...
  return (
    <div className={styles["header-overall-wrapper"]}>
      <div className={styles["header-wrapper"]}>
        ...
        <div className={styles["header-actions"]}>
          <div
            ...
            style={{
              border:
                showSearch && window.innerWidth > 960
                  ? "0.5px solid black"
                  : "none",
            }}
          >
          ...
          <button
            className={`${styles["header-btn"]} ${styles["profile-btn"]}`}
            type="button"
          >
            <img src={profile} />
          </button>
      ...
      {showMobileMenu && <MobileMenu handleExit={handleExitNavbar} />}
      {window.innerWidth <= 960 && showSearch && (
